...
export const rowsGaraze = [
	...
	createData(11, 'B1.11', '50.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'wolne', B1G[11]),
	...
	createData(16, 'B1.16-B1.16A', '70.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'wolne', B1G[16]),
