...
export const rowsKomorka = [
	...
	createData(1, 'B3-1.13', 4.41, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[13]),
	createData(1, 'B3-1.14', 4.34, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[14]),
	// createData(1, 'B3-1.15', 0.00, 4000, <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[15]),
	createData(1, 'B3-1.16', 4.99, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[16]),
	createData(1, 'B3-1.17', 5.06, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[17]),
	createData(1, 'B3-1.18', 4.62, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[18]),
	createData(1, 'B3-1.19', 2.65, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[19]),
	...
	createData(1, 'B3-1.22', 3.37, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[22]),
	createData(1, 'B3-1.23', 2.61, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[23]),
	createData(1, 'B3-1.24', 2.61, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[24]),
	createData(1, 'B3-1.25', 2.73, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[25]),
	createData(1, 'B3-1.26', 2.48, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[26]),
	createData(1, 'B3-1.27', 2.48, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[27]),
	createData(1, 'B3-1.28', 3.53, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[28]),
	createData(1, 'B3-1.29', 3.53, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'wolne', B31[29]),
	createData(1, 'B3-1.30', 2.74, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[30]),
	createData(1, 'B3-1.31', 2.74, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'wolne', B31[31]),
	createData(1, 'B3-1.32', 2.74, '4.000', <img className='iconPdf' src={greenPdf} alt={'pdf'}/>, 'zarezerwowane', B31[32]),
